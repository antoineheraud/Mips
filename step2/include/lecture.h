...
LISTE lecture_instruction(LISTE* collect_ins,int* pinst,char* token, char* type, int* nbop, int* nline, int* dec, OPINST* opt1,OPINST* opt2,OPINST* opt3, LISTE l,inst_def_t* dict, int* p_nb_inst,psinst_def_t* pseudo_dict, int* p_nb_pseudo_inst);
